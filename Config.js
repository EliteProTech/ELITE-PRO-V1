...
// Creator details
global.ownernumber = process.env.OWNER_NUMBER || '2348108922068';
global.ownername = process.env.OWNER_NAME || 'AnomPro';
global.botname = process.env.BOT_NAME || 'Anon-PRO-V1';
