...
async function handleBrat(EliteProTech, message, text) {
  ...
  try {
    ...
    try {
      // This project’s Baileys helper sends stickers as a local file URL.
      ...
      // Some Baileys builds accept the encoded sticker buffer instead.
      console.error('Brat file sticker send failed, retrying with buffer:', fileSendError.message);
